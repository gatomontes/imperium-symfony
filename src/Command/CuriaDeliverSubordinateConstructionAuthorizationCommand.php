...
#[AsCommand(name: 'imperium:curia:deliver-subordinate-construction-authorization', description: 'Deliver an exact personnel authorization act to Guildhall')]
final class CuriaDeliverSubordinateConstructionAuthorizationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('<info>SUBORDINATE_CONSTRUCTION_AUTHORIZATION_DELIVERED</info> '.$delivery['delivery_id']); $output->writeln('Guildhall: '.$delivery['status']);
        ...
        $output->writeln('Recipient acceptance: NOT RECORDED'); $output->writeln('Guildhall personnel commission authority: PRESENT');
