...
#[AsCommand(
    name: 'imperium:demonstrate:operational-construction-recovery',
    description: 'Run Crash Demonstration 1 with retained private evidence and a sanitized summary',
)]
final class DemonstrateOperationalConstructionRecoveryCommand extends Command
{
    public function __construct(private readonly OperationalConstructionCrashDemonstration $demonstration)
    {
        parent::__construct();
    }
    ...
    protected function configure(): void
    {
        $this->addOption(
            ...
            'var/imperium/private-evidence/crash-demonstration-1',
        );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('<info>PROVED</info> Crash Demonstration 1: operational construction recovery');
