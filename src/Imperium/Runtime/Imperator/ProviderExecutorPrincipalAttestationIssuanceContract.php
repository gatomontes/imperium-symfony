...
final class ProviderExecutorPrincipalAttestationIssuanceContract
{
    public const string DECISION_SCHEMA = 'imperium.imperator.provider-executor-principal-attestation-decision/v1';
    public const string ISSUANCE_SCHEMA = 'imperium.imperator.provider-executor-principal-attestation-issuance/v1';
    public const int VERSION = 1;
    public const string TARGET_KIND = 'provider_executor_principal';
    public const string PERMITTED_TRANSITION = 'ISSUE_EXACT_PROVIDER_EXECUTOR_PRINCIPAL_ATTESTATION';
    ...
    public const array REQUIRED_ISSUANCE_FIELDS = [
        ...
        'principal_attestation_issued', 'principal_installed', 'provider_binding_activated',
