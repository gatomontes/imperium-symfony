...
final class DurableProviderExecutionAuthorityIssuanceContract
{
    public const string DECISION_SCHEMA = 'imperium.imperator.durable-provider-execution-authority-decision/v1';
    public const string ISSUANCE_SCHEMA = 'imperium.imperator.durable-provider-execution-authority-issuance/v1';
    public const int VERSION = 1;
    public const string TARGET_KIND = 'durable_provider_execution_authority';
    public const string PERMITTED_TRANSITION = 'ISSUE_EXACT_DURABLE_PROVIDER_EXECUTION_AUTHORITY';
    ...
    public const array REQUIRED_ISSUANCE_FIELDS = [
        ...
        'execution_authority_issued', 'principal_installed', 'provider_binding_activated',
