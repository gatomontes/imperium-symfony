...
final class SingleOperationProviderBindingActivationIssuanceContract
{
    public const string DECISION_SCHEMA = 'imperium.imperator.single-operation-provider-binding-activation-decision/v1';
    public const string ISSUANCE_SCHEMA = 'imperium.imperator.single-operation-provider-binding-activation-issuance/v1';
    public const int VERSION = 1;
    public const string TARGET_KIND = 'single_operation_provider_binding_activation';
    public const string PERMITTED_TRANSITION = 'ISSUE_EXACT_SINGLE_OPERATION_PROVIDER_BINDING_ACTIVATION';
    ...
    public const array REQUIRED_ISSUANCE_FIELDS = [
        ...
        'binding_activation_issued', 'principal_installed', 'provider_binding_activated',
