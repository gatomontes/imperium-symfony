...
final readonly class CanonicalNativeEffectCorridor
{
    ...
    public function reconciliationIssuanceDecision(): NativeEffectReconciliationIssuanceDecisionService
    {
        return new NativeEffectReconciliationIssuanceDecisionService($this->state);
    }
