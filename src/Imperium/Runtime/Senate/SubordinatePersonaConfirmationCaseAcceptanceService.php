...
final readonly class SubordinatePersonaConfirmationCaseAcceptanceService
{
    ...
    public function accept(string $caseId): array
    {
        ...
        return $this->persist($id, [
            ...
            "disposition" => "ACCEPTED_FOR_EXACT_PERSONA_WITNESS_INSTANTIATION",
            "status" => "ACCEPTED_PENDING_PERSONA_WITNESS_INSTANTIATION",
            "recipient_acceptance" => true,
            "assembly_request_authority" => false,
            "assembly_request_authority_exercisable" => false,
            "witness_instantiation_authority" => true,
