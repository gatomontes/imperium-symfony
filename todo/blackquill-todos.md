...
- [x] Batch 1: define process-incarnation custody and governed recovery contracts.
...
- [x] Stored operation/root mapping and established broker reachability.
- [x] Descriptor, array, cached-result and generic email bypass refusal.
- [x] Real Kernel/container/Application and separate-process evidence.
- [x] Read-only historical reconstruction, expiry/revocation and unknown replay.
- [x] Separate audit after corrected Batch 3A merge; fixture and live-effect limits retained.
