...
foreach($name in @('local-isolation-readiness-owner-runbook.md','local-isolation-readiness-c0.md','local-isolation-readiness-c1.md','local-isolation-readiness-c2.md','local-isolation-readiness-audit.json','local-isolation-readiness-terminal-audit.md','local-isolation-package-independent-review.md','next-campaign-local-isolation-measurement-readiness.md','next-campaign-local-isolation-useful-mission.md','local-isolation-terminal-audit.md','local-isolation-target-manifest.json','local-isolation-report-template.md')){Add-ReviewSource "$Source\docs\$name" 'Public instructions/evidence; historical records retain their attribution'}
foreach($name in @('LocalIsolationReadiness.ps1','New-LocalIsolationProbePlans.ps1','New-LocalIsolationMeasurement.ps1','Test-LocalIsolationAccess.ps1','Collect-LocalIsolationStartup.ps1','Import-LocalIsolationMeasurement.ps1','Test-LocalIsolationPhase.ps1','Seal-LocalIsolationReadiness.ps1','Test-LocalIsolationReadiness.ps1','Install-LocalIsolationOwnerPackage.ps1','Install-ProtectedMission.ps1','Assert-ProtectedMissionInstallation.ps1','Invoke-LocalMission.ps1','LocalMission.ps1','ProtectedMission.ps1','LocalIsolation.php','local-isolation.php','sign-protected-mission.php','Build-LocalIsolationPackage.ps1','Build-LocalIsolationReadinessReview.ps1','Test-LocalIsolationInstalledPackage.ps1')){Add-ReviewSource "$Package\ProtectedMissionCode\tools\$name" 'Exact packaged executable'}
...
[void]$builder.AppendLine('# Local Isolation Measurement and Readiness — independent review packet')
[void]$builder.AppendLine("`nLOCAL_ISOLATION_MEASUREMENT_READINESS_PACKAGE_READY is a local preparation status, not independent acceptance or deployed isolation. Parent Batches 3–5 remain conditional on authentic owner setup/evidence and exact signature. No real mission has run.")
...
[void]$builder.AppendLine("`nRead the new runbook, C0/C1/C2 contracts and terminal audit first, then executable/test sources and complete manifest. The original package-47bcc44a and its 8DAB48F98D147A6ABA9E89260D25082BA5B91AD2C72638F1F10FFB9A449CF6AE manifest remain preserved historical evidence; do not install it. Historical instructions/counts are not current authority. The original review assembler and packet remain unchanged.")
...
$packet=Join-Path $OutputDirectory 'local-isolation-readiness-independent-review.md'
