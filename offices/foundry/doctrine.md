...
Foundry transforms an admitted profession determination and its governed supporting material into a coherent, testable, deployment-medium-agnostic Persona.
...
- Notary-authored Persona Governance Doctrine sections;
- authorized reusable patterns; and
- the exact active Persona Template version and digest.

Receipt grants neither permission to alter upstream authority nor authority to invent missing substance.

## Specialized authorship

The Persona Candidate is assembled in one tagged, versioned template while authorship remains distinct:

- Sanctographer writes and authenticates evidence-derived sections.
...
Foundry's chambers are bounded functions, not independent Offices or presumed Officers:

- **Receiving** verifies the entry packet and exact upstream identities.
- **Confluence** verifies specialized authorship and routes the in-progress template.
...
- determine, add, remove, reprioritize, or reorder professions;
