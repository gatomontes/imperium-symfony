...
6. Adding or transitioning a Folium requires a new Codex digest.
7. Exact replay returns the existing Codex only when the complete authoritative-input fingerprint matches.
8. Omission, substitution, reordering, conflicting replay, or digest mismatch fails stopped.
