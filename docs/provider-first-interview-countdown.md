...
**Working estimate: 5–7 batches remaining. Next: PPC3, native tenure synchronization.**
...
| R2. Native tenure and registry synchronization, including indirect lock order | 1 | **Selected: PPC3** under approved A–F |
