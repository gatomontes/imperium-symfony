...
issuer and claim-use currentness path passed bounded adversarial, process,
contention, interruption, application and frozen-runtime proof.
...
completion with tests after each batch. The separate Batch 5 audit is in progress. Provider effects,
...
25. `docs/handoffs/transactional-authority-consumption-batch-3-complete.md`;
...
35. `docs/handoffs/transactional-authority-consumption-batch-12-complete.md`;
36. `docs/handoffs/transactional-authority-consumption-campaign-complete.md`;
...
49. `docs/handoffs/iron-gate-execution-receipt-binding-batch-4-complete.md`;
50. `docs/iron-gate-outbound-email-native-records.md`;
51. `docs/handoffs/iron-gate-execution-receipt-binding-batch-5-complete.md`;
52. `docs/iron-gate-deterministic-execution-claim.md`;
53. `docs/handoffs/iron-gate-execution-receipt-binding-batch-6-complete.md`;
54. `docs/iron-gate-effect-start-journal.md`;
55. `docs/handoffs/iron-gate-execution-receipt-binding-batch-7-complete.md`;
56. `docs/iron-gate-journal-bound-agentmail-invocation.md`;
57. `docs/handoffs/iron-gate-execution-receipt-binding-batch-8-complete.md`;
...
63. `docs/handoffs/iron-gate-execution-receipt-binding-campaign-complete.md`;
64. `docs/next-campaign-iron-gate-evidence-authenticity-remediation.md`;
65. `docs/iron-gate-evidence-authenticity-remediation-preparation-inventory.md`;
...
70. `docs/handoffs/iron-gate-evidence-authenticity-remediation-batch-3-complete.md`;
71. `docs/handoffs/iron-gate-evidence-authenticity-remediation-batch-4-complete.md`;
72. `docs/handoffs/iron-gate-evidence-authenticity-remediation-batch-5-complete.md`;
73. `docs/iron-gate-runtime-principal-caller-authority-and-integrity-threat-model.md`;
74. `docs/handoffs/iron-gate-evidence-authenticity-remediation-batch-6-complete.md`;
75. `docs/handoffs/iron-gate-evidence-authenticity-remediation-batch-7-complete.md`;
76. `docs/handoffs/iron-gate-evidence-authenticity-remediation-batch-8-complete.md`;
77. `docs/handoffs/iron-gate-evidence-authenticity-remediation-batch-9-complete.md`;
78. `docs/iron-gate-evidence-authenticity-adversarial-proof.md`;
79. `docs/handoffs/iron-gate-evidence-authenticity-remediation-batch-10-complete.md`;
...
90. `docs/handoffs/governed-tool-provider-separation-batch-1-complete.md`;
91. `docs/governed-email-send-tool-definition.md`;
92. `docs/handoffs/governed-tool-provider-separation-batch-2-complete.md`; and
...
111. `docs/corridor-disposition-principal-authority-remediation-contracts.md`;
...
deterministic evidence corridor is complete but the separately selected authenticity remediation
records that provider response provenance is not yet sufficient for live adoption.
...
Corridor Disposition Principal Authority Remediation Batch 2 now provides pure fail-closed validators
and segregated immutable offline fixture stores. No live state or authority is produced. Only Batch 3
offline replay and interruption proof is authorized next.
