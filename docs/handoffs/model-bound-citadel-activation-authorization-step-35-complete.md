# Handoff: model-bound Citadel activation authorization complete
...
This transition authorizes neither mission deployment nor Garrison custody transfer. The Manifestation remains runtime-inactive and prohibited from operational use, tools, credentials, provider invocation, external action, execution, or continuing cognition.

## Next

Step 36 is mechanical runtime activation by Conscription. It must consume the exact single-use authority and stop before any cognition or provider invocation.
