...
| O2-B0 | Original policy/act/reference admission and current authority checks for the selected bootstrap route | Reviewed HOLD; R1-R4 corrected and locally validated, pending renewed source review/full CI/integration. [Correction report](handoffs/provider-onboarding-o2-b0-correction-report.md). O2 remains open. |
