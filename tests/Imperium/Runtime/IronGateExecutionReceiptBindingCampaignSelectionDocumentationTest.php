...
final class IronGateExecutionReceiptBindingCampaignSelectionDocumentationTest extends TestCase
{
    public function testSelectionAuthorizesInventoryOnlyAndNamesTheExactUnknownOutcomeGap(): void
    {
        ...
        self::assertStringContainsString('`BATCH_1_COMPLETE`', $campaign);
        ...
        self::assertStringContainsString('Preparation Batch 0 and contract-definition Batch 1 are complete', $campaign);
    ...
    public function testPreparationKeepsEveryRuntimeAndPerimeterMutationClosed(): void
    {
        ...
        self::assertStringContainsString('Batch 1 has defined', $flow);
        self::assertStringContainsString('Batch 2 is', $flow);
    }
}
