...
final class IronGateExecutionReceiptBindingCampaignSelectionDocumentationTest extends TestCase
{
    public function testSelectionAuthorizesInventoryOnlyAndNamesTheExactUnknownOutcomeGap(): void
    {
        ...
        self::assertStringContainsString('`BATCH_7_EFFECT_START_UNKNOWN_OUTCOME_BOUNDARY_DURABLE`', $campaign);
        ...
        self::assertStringContainsString('Batches 1–7 are complete', $campaign);
    ...
    public function testPreparationKeepsEveryRuntimeAndPerimeterMutationClosed(): void
    {
        ...
        self::assertStringContainsString('neither consumes nor resolves', $flow);
        self::assertStringContainsString('Batch 7 binds the exact', $flow);
        self::assertStringContainsString('Batch 8 is not authorized', $flow);
    }
}
