...
final class IronGateEvidenceAuthenticityRemediationBatch3Test extends TestCase
{
    ...
    public function testHandoffPreservesUnknownAndKeepsLiveConsumersClosed(): void
    {
        ...
        foreach (['Callers can no longer supply', '`UNKNOWN_REPLAY_PROHIBITED`', 'Only Batch 4 may next be considered', 'Batch 4 is not authorized', 'no external I/O occurs'] as $proof) self::assertStringContainsString($proof, $handoff);
    }
}
