...
final class IronGateExecutionReceiptBindingBatch8Test extends TestCase
{
    public function testAdmissionContractAndDocumentationKeepLiveIoAndReceiptsClosed(): void
    {
        ...
        foreach (['`BATCH_8_JOURNAL_GATED_PROVIDER_CALLBACK_NO_LIVE_IO`', '`admission_committed=true`', '`consumption_attempted=false`', '`provider_callback_may_have_run=true`', '`UNKNOWN_REPLAY_PROHIBITED`', 'No live network request'] as $proof) {
