...
use App\Imperium\Runtime\Conscription\OperationalManifestationSeatBindingService;
...
final class ProfileElaborationSmokeServiceTest extends TestCase
{
    public function testSenateRefusalGrantsNoAssemblyAuthority(): void
    {
        ...
        try {
            $result = (new ProfileElaborationSmokeService($cognition, $this->questionCognition(), $this->testimonyCognition(), $this->findingCognition(), $this->reconciliationCognition(), $this->dispositionCognition(),$this->operationalExecutionCognition()))->run($root, 'REFUSED');
    ...
    public function testIsolatedDriverPersistsTheCompleteGovernedChainAndCandidate(): void
    {
        ...
        try {
            $result = (new ProfileElaborationSmokeService($cognition, $this->questionCognition(), $this->testimonyCognition(), $this->findingCognition(), $this->reconciliationCognition(), $this->dispositionCognition(),$this->operationalExecutionCognition()))->run($root);
            ...
            self::assertSame('PROFILE_OPERATIONALLY_QUALIFIED_PENDING_MANIFESTATION_ASSEMBLY',$result['operational_qualification']['status']);self::assertTrue($result['operational_qualification']['operational_qualification_request_authority_consumed']);self::assertTrue($result['operational_qualification']['profile_installation_scope_consumed']);self::assertTrue($result['operational_qualification']['profile_installed']);self::assertTrue($result['operational_qualification']['profile_operationally_qualified']);self::assertTrue($result['operational_qualification']['manifestation_assembly_authority']);self::assertTrue($result['operational_qualification']['manifestation_assembly_authority_exercisable']);
            self::assertFalse($result['operational_qualification']['seat_binding_authority']);self::assertFalse($result['operational_qualification']['deployment_authority']);self::assertFalse($result['operational_qualification']['custody_transfer_authority']);self::assertFalse($result['operational_qualification']['execution_authority']);
            self::assertSame('mission.operative.slot-passive-web-assessment',$result['operational_qualification']['operational_profile']['intended_seat']['seat']);self::assertSame(['kind'=>'generic-officer','version'=>0,'identity_contribution'=>false,'authority_contribution'=>false],$result['operational_qualification']['operational_profile']['substrate_contract']);self::assertSame($result['candidate']['profile']['mission'],$result['operational_qualification']['operational_profile']['mission']);self::assertSame($result['candidate']['profile']['limitations'],$result['operational_qualification']['operational_profile']['limitations']);self::assertSame($result['candidate']['return_destination'],$result['operational_qualification']['operational_profile']['return_destination']);self::assertSame($result['profile_approval']['return_destination'],$result['operational_qualification']['operational_profile']['examination_return_destination']);self::assertSame($result['candidate']['record_digest'],$result['operational_qualification']['profile_candidate']['digest']);self::assertSame($result['profile_approval']['record_digest'],$result['operational_qualification']['source_imperator_approval']['digest']);self::assertSame($result['profile_approval']['admitted_findings'],$result['operational_qualification']['admitted_findings']);self::assertSame($result['profile_approval']['reconciliation'],$result['operational_qualification']['reconciliation']);
            self::assertSame($result['operational_qualification'],(new OperationalProfileQualificationService($root,new \App\Bootstrap\StateStore($root)))->qualify($result['profile_approval']['decision_id']));self::assertFileExists($root.'/var/imperium/offices/conscription/operational-profile-qualifications/'.$result['operational_qualification']['qualification_id'].'.json');
            self::assertSame('OPERATIONAL_MANIFESTATION_ASSEMBLED_PENDING_SEAT_BINDING',$result['operational_manifestation']['status']);self::assertTrue($result['operational_manifestation']['manifestation_assembly_authority_consumed']);self::assertTrue($result['operational_manifestation']['operational_manifestation_assembled']);self::assertTrue($result['operational_manifestation']['seat_binding_authority']);self::assertTrue($result['operational_manifestation']['seat_binding_authority_exercisable']);self::assertFalse($result['operational_manifestation']['seat_bound']);
            self::assertFalse($result['operational_manifestation']['deployment_authority']);self::assertFalse($result['operational_manifestation']['custody_transfer_authority']);self::assertFalse($result['operational_manifestation']['tool_access_authority']);self::assertFalse($result['operational_manifestation']['credentials_authority']);self::assertFalse($result['operational_manifestation']['external_action_authority']);self::assertFalse($result['operational_manifestation']['execution_authority']);
            self::assertSame('ASSEMBLED_UNBOUND',$result['operational_manifestation']['manifestation']['status']);self::assertFalse($result['operational_manifestation']['manifestation']['seat_bound']);self::assertFalse($result['operational_manifestation']['manifestation']['operational_use_permitted']);self::assertFalse($result['operational_manifestation']['manifestation']['tool_access_granted']);self::assertFalse($result['operational_manifestation']['manifestation']['credentials_granted']);self::assertFalse($result['operational_manifestation']['manifestation']['external_action_authority']);self::assertSame($result['profile_approval']['persona_identity'],$result['operational_manifestation']['manifestation']['persona']);self::assertSame($result['operational_qualification']['operational_profile'],$result['operational_manifestation']['manifestation']['profile']);self::assertSame($result['operational_qualification']['operational_profile']['substrate_contract'],$result['operational_manifestation']['manifestation']['substrate']);self::assertSame($result['operational_qualification']['operational_profile']['intended_seat'],$result['operational_manifestation']['manifestation']['intended_seat']);self::assertSame($result['operational_qualification']['record_digest'],$result['operational_manifestation']['source_qualification']['digest']);
            self::assertSame($result['operational_manifestation'],(new OperationalManifestationAssemblyService($root,new \App\Bootstrap\StateStore($root)))->assemble($result['operational_qualification']['qualification_id']));self::assertFileExists($root.'/var/imperium/offices/conscription/operational-manifestation-assemblies/'.$result['operational_manifestation']['assembly_id'].'.json');
            self::assertSame('OPERATIONAL_MANIFESTATION_BOUND_PENDING_DEPLOYMENT_AUTHORIZATION',$result['operational_seat_binding']['status']);self::assertTrue($result['operational_seat_binding']['binding_atomic']);self::assertTrue($result['operational_seat_binding']['seat_binding_authority_consumed']);self::assertTrue($result['operational_seat_binding']['seat_bound']);self::assertSame(0,$result['operational_seat_binding']['prior_occupancy_generation']);self::assertSame(1,$result['operational_seat_binding']['occupancy_generation']);self::assertNull($result['operational_seat_binding']['supersedes']);self::assertFalse($result['operational_seat_binding']['supersession_authority']);
            self::assertTrue($result['operational_seat_binding']['deployment_authorization_pending']);self::assertFalse($result['operational_seat_binding']['operational_use_permitted']);self::assertFalse($result['operational_seat_binding']['tool_access_authority']);self::assertFalse($result['operational_seat_binding']['credentials_authority']);self::assertFalse($result['operational_seat_binding']['external_action_authority']);self::assertFalse($result['operational_seat_binding']['deployment_authority']);self::assertFalse($result['operational_seat_binding']['custody_transfer_authority']);self::assertFalse($result['operational_seat_binding']['execution_authority']);
            self::assertSame($result['operational_manifestation']['manifestation']['intended_seat']['seat'],$result['operational_seat_binding']['seat']);self::assertSame($result['operational_manifestation']['manifestation']['manifestation_id'],$result['operational_seat_binding']['manifestation_id']);self::assertSame($result['operational_manifestation']['record_digest'],$result['operational_seat_binding']['source_assembly']['digest']);self::assertSame($result['operational_manifestation']['manifestation'],$result['operational_seat_binding']['manifestation']);self::assertSame($result['operational_manifestation']['admitted_findings'],$result['operational_seat_binding']['admitted_findings']);self::assertSame($result['operational_manifestation']['reconciliation'],$result['operational_seat_binding']['reconciliation']);
            self::assertSame($result['operational_seat_binding'],(new OperationalManifestationSeatBindingService($root,new \App\Bootstrap\StateStore($root)))->bind($result['operational_manifestation']['assembly_id']));self::assertFileExists($root.'/var/imperium/mission/occupancy/'.$result['operational_seat_binding']['binding_id'].'.json');
            self::assertSame('DEPLOYMENT_AUTHORIZED_PENDING_GARRISON_CUSTODY_TRANSITION',$result['deployment_authorization']['status']);self::assertTrue($result['deployment_authorization']['deployment_authority']);self::assertTrue($result['deployment_authorization']['deployment_authority_exercisable']);self::assertTrue($result['deployment_authorization']['garrison_custody_transition_authority']);self::assertTrue($result['deployment_authorization']['garrison_custody_transition_authority_exercisable']);self::assertFalse($result['deployment_authorization']['operational_use_permitted']);self::assertFalse($result['deployment_authorization']['tool_access_authority']);self::assertFalse($result['deployment_authorization']['credentials_authority']);self::assertFalse($result['deployment_authorization']['external_action_authority']);self::assertFalse($result['deployment_authorization']['execution_authority']);
            self::assertSame($result['operational_seat_binding']['record_digest'],$result['deployment_authorization']['source_binding']['digest']);self::assertSame($result['operational_seat_binding']['manifestation'],$result['deployment_authorization']['manifestation']);self::assertSame($result['operational_seat_binding']['persona_identity'],$result['deployment_authorization']['persona_identity']);self::assertSame($result['operational_seat_binding']['profile_candidate'],$result['deployment_authorization']['profile_candidate']);self::assertSame($result['operational_seat_binding']['custody_lease'],$result['deployment_authorization']['custody_lease']);self::assertSame($result['operational_seat_binding']['admitted_findings'],$result['deployment_authorization']['admitted_findings']);self::assertSame($result['operational_seat_binding']['reconciliation'],$result['deployment_authorization']['reconciliation']);self::assertFileExists($root.'/var/imperium/offices/curia/operational-deployment-authorizations/'.$result['deployment_authorization']['authorization_id'].'.json');
            self::assertSame('OPERATIONAL_MANIFESTATION_DEPLOYED_CUSTODY_TRANSITIONED_PENDING_BOUNDED_EXECUTION',$result['operational_custody_transition']['status']);self::assertTrue($result['operational_custody_transition']['deployment_authority_consumed']);self::assertTrue($result['operational_custody_transition']['garrison_custody_transition_authority_consumed']);self::assertTrue($result['operational_custody_transition']['deployed']);self::assertTrue($result['operational_custody_transition']['bounded_execution_authorization_pending']);self::assertFalse($result['operational_custody_transition']['operational_use_permitted']);self::assertFalse($result['operational_custody_transition']['tool_access_authority']);self::assertFalse($result['operational_custody_transition']['credentials_authority']);self::assertFalse($result['operational_custody_transition']['external_action_authority']);self::assertFalse($result['operational_custody_transition']['execution_authority']);self::assertFalse($result['operational_custody_transition']['return_authority']);self::assertFalse($result['operational_custody_transition']['retirement_authority']);self::assertFalse($result['operational_custody_transition']['unbinding_authority']);self::assertFalse($result['operational_custody_transition']['supersession_authority']);
            self::assertSame($result['deployment_authorization']['record_digest'],$result['operational_custody_transition']['source_deployment_authorization']['digest']);self::assertSame($result['deployment_authorization']['mission_use'],$result['operational_custody_transition']['mission_use']);self::assertSame('ADMITTED_HELD',$result['operational_custody_transition']['prior_custody']['state']);self::assertTrue($result['operational_custody_transition']['prior_custody']['available']);self::assertSame('DEPLOYED_BOUND',$result['operational_custody_transition']['operational_custody']['state']);self::assertFalse($result['operational_custody_transition']['operational_custody']['available']);self::assertSame($result['operational_seat_binding']['seat'],$result['operational_custody_transition']['operational_custody']['custodian']['seat']);self::assertSame($result['operational_seat_binding']['manifestation_id'],$result['operational_custody_transition']['operational_custody']['custodian']['manifestation_id']);self::assertFileExists($root.'/var/imperium/offices/garrison/operational-custody-transitions/'.$result['operational_custody_transition']['transition_id'].'.json');
            self::assertSame($result['deployment_authorization'],(new OperationalDeploymentAuthorizationService($root))->authorize($result['operational_seat_binding']['binding_id'],'curia-seneschal-binding-'.str_repeat('9',20),$result['deployment_authorization']['mission_use']));self::assertSame($result['operational_custody_transition'],(new OperationalCustodyTransitionService($root))->transition($result['deployment_authorization']['authorization_id'],'garrison-constable-binding-'.str_repeat('d',20)));
            self::assertSame('BOUNDED_EXECUTION_AUTHORIZED_PENDING_ONE_ITERATION',$result['bounded_execution_authorization']['status']);self::assertTrue($result['bounded_execution_authorization']['bounded_execution_authority']);self::assertTrue($result['bounded_execution_authorization']['bounded_execution_authority_exercisable']);self::assertSame(1,$result['bounded_execution_authorization']['maximum_iterations']);self::assertFalse($result['bounded_execution_authorization']['tool_access_authority']);self::assertFalse($result['bounded_execution_authorization']['credentials_authority']);self::assertFalse($result['bounded_execution_authorization']['external_action_authority']);self::assertFalse($result['bounded_execution_authorization']['network_access_authority']);self::assertFalse($result['bounded_execution_authorization']['continuing_execution_authority']);
            self::assertSame('OPERATIONAL_MANIFESTATION_BOUNDED_EXECUTION_COMPLETED_PENDING_RETURN',$result['bounded_execution']['status']);self::assertTrue($result['bounded_execution']['bounded_execution_authority_consumed']);self::assertSame(1,$result['bounded_execution']['iterations_consumed']);self::assertTrue($result['bounded_execution']['execution_complete']);self::assertTrue($result['bounded_execution']['output_attributable']);self::assertFalse($result['bounded_execution']['tool_access_used']);self::assertFalse($result['bounded_execution']['credentials_used']);self::assertFalse($result['bounded_execution']['external_action_performed']);self::assertFalse($result['bounded_execution']['network_access_performed']);self::assertFalse($result['bounded_execution']['continuing_execution_authority']);self::assertFalse($result['bounded_execution']['return_authority']);self::assertFalse($result['bounded_execution']['unbinding_authority']);self::assertSame($result['bounded_execution_authorization']['record_digest'],$result['bounded_execution']['source_execution_authorization']['digest']);self::assertSame($result['operational_seat_binding']['manifestation_id'],$result['bounded_execution']['manifestation_id']);self::assertSame($result['bounded_execution_authorization']['input_digest'],$result['bounded_execution']['input_digest']);
            self::assertSame($result['bounded_execution_authorization'],(new BoundedExecutionAuthorizationService($root))->authorize($result['operational_custody_transition']['transition_id'],'curia-seneschal-binding-'.str_repeat('9',20),$result['bounded_execution_authorization']['input']));self::assertSame($result['bounded_execution'],(new BoundedOperationalExecutionService($root,$this->operationalExecutionCognition()))->execute($result['bounded_execution_authorization']['authorization_id']));
            self::assertSame('OPERATIONAL_RETURN_AUTHORIZED_PENDING_GARRISON_RETIREMENT',$result['operational_return_authorization']['status']);self::assertTrue($result['operational_return_authorization']['return_authority_exercisable']);self::assertTrue($result['operational_return_authorization']['retirement_authority_exercisable']);self::assertTrue($result['operational_return_authorization']['unbinding_authority_exercisable']);self::assertTrue($result['operational_return_authorization']['custody_restoration_authority_exercisable']);self::assertFalse($result['operational_return_authorization']['execution_authority']);self::assertFalse($result['operational_return_authorization']['redeployment_authority']);self::assertSame($result['bounded_execution']['record_digest'],$result['operational_return_authorization']['source_bounded_execution']['digest']);
            self::assertSame('OPERATIONAL_MANIFESTATION_RETURNED_RETIRED_CUSTODY_RESTORED',$result['operational_return_retirement']['status']);self::assertTrue($result['operational_return_retirement']['return_authority_consumed']);self::assertTrue($result['operational_return_retirement']['retirement_authority_consumed']);self::assertTrue($result['operational_return_retirement']['unbinding_authority_consumed']);self::assertTrue($result['operational_return_retirement']['custody_restoration_authority_consumed']);self::assertTrue($result['operational_return_retirement']['returned']);self::assertTrue($result['operational_return_retirement']['manifestation_retired']);self::assertFalse($result['operational_return_retirement']['seat_bound']);self::assertTrue($result['operational_return_retirement']['custody_restored']);self::assertFalse($result['operational_return_retirement']['execution_authority']);self::assertFalse($result['operational_return_retirement']['continuing_authority']);self::assertFalse($result['operational_return_retirement']['redeployment_authority']);self::assertFalse($result['operational_return_retirement']['reuse_authority']);self::assertSame('DEPLOYED_BOUND',$result['operational_return_retirement']['prior_operational_custody']['state']);self::assertSame('ADMITTED_HELD',$result['operational_return_retirement']['restored_custody']['state']);self::assertTrue($result['operational_return_retirement']['restored_custody']['available']);self::assertSame($result['bounded_execution']['output'],$result['operational_return_retirement']['operational_transcript']['output']);
            self::assertSame($result['operational_return_authorization'],(new OperationalReturnAuthorizationService($root))->authorize($result['bounded_execution']['execution_id'],'curia-seneschal-binding-'.str_repeat('9',20)));self::assertSame($result['operational_return_retirement'],(new OperationalReturnRetirementService($root))->complete($result['operational_return_authorization']['authorization_id'],'garrison-constable-binding-'.str_repeat('d',20)));self::assertFileExists($root.'/var/imperium/offices/garrison/operational-return-retirements/'.$result['operational_return_retirement']['terminal_id'].'.json');
    ...
    private function operationalExecutionCognition(): OperationalExecutionCognitionGateway
    {
        return new class implements OperationalExecutionCognitionGateway {public function execute(array$authorization,array$manifestation):array{return['disposition'=>'COMPLETED','output'=>'The supplied target is accepted for passive assessment; no observation is claimed without external access.','evidence_claims'=>['The exact HTTPS target URL was supplied.','No tool, credential, network, or external action authority was granted.'],'uncertainties'=>['No target behavior was observed during this internal-only iteration.'],'stop_condition_triggered'=>false,'stop_rationale'=>'No declared stop condition was triggered by accepting the bounded input.'];}};
    }
}
