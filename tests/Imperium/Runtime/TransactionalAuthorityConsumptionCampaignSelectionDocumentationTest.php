...
final class TransactionalAuthorityConsumptionCampaignSelectionDocumentationTest extends TestCase
{
    public function testSelectionHistoryAndCurrentBatchKeepRuntimeAndExternalBoundariesClosed(): void
    {
        ...
        self::assertStringContainsString('`BATCH_7_MODEL_BOUND_PROFILE_SENATE_OPENINGS_ADOPTED_BATCH_8_NOT_AUTHORIZED`', $campaign);
        ...
        self::assertStringContainsString('Batch 8 remains unopened pending explicit authorization', $flow);
        self::assertStringContainsString('Transactional Authority Consumption Adoption is complete through Batch 7', $index);
    }
}
