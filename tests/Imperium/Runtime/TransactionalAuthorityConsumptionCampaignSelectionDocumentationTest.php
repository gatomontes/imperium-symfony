...
final class TransactionalAuthorityConsumptionCampaignSelectionDocumentationTest extends TestCase
{
    public function testSelectionHistoryAndCurrentBatchKeepRuntimeAndExternalBoundariesClosed(): void
    {
        ...
        self::assertStringContainsString('`BATCH_3_COMPLETE_BATCH_4_NOT_AUTHORIZED`', $campaign);
        ...
        self::assertStringContainsString('Batch 4 remains unopened pending explicit authorization', $flow);
        self::assertStringContainsString('Transactional Authority Consumption Adoption is complete through Batch 3', $index);
    }
}
