...
use App\Imperium\Runtime\Imperator\ProviderBindingSuccessorLiveAdoptionAuthorityBoundaryContractValidator as Validator;
use App\Imperium\Runtime\Imperator\ProviderBindingSuccessorLiveAdoptionAuthorityContract as Authority;
use App\Imperium\Runtime\Imperator\ProviderBindingSuccessorLiveAdoptionAuthorityIssuanceBoundaryContract as Issuance;
use App\Imperium\Runtime\Imperator\ProviderBindingSuccessorLiveAdoptionDecisionIssuerContract as DecisionIssuer;
use App\Imperium\Runtime\Imperator\ProviderBindingSuccessorLiveAdoptionDecisionPrincipalContract as Principal;
use PHPUnit\Framework\TestCase;

final class ProviderBindingSuccessorLiveAdoptionBatch2Test extends TestCase
{
    ...
    public function testProcessLocalPersistenceClaimRefuses(): void
    {
    ...
    {
        $doc = $this->document(
            'docs/provider-binding-successor-live-adoption-batch-2-contracts.md',
        );
        ...
        foreach ([
            ...
            'may not produce a decision, issue authority, consume live authority, admit live execution, adopt a live successor or change live binding state',
    ...
    private function fixture(): array
    {
        $custody = $this->seal([
            ...
            'custody_boundary_id' => 'live-adoption-authority-custody.1',
            ...
            'authorized_consumer' => [
                'service' => 'la-cortine.future-atomic-successor-live-adoption',
        ...
        $issuance = $this->seal([
            ...
            'issuance_boundary_id' => 'live-adoption-authority-issuance.1',
            'instance_id' => 'instance.1',
            'exact_principal' => [
                'id' => 'imperator-successor-live-adoption-principal.1',
                'digest' => str_repeat('a', 64),
                'schema' => Principal::SCHEMA,
            ],
            'decision_issuer' => [
                'id' => 'provider-binding-successor-live-adoption-decision-issuer.1',
