...
final class FreshModelPreparationFixture
{
    public FreshEstablishmentFixture $f;
    ...
    public function __construct(FreshEstablishmentFixture $combined, public string $seat = 'courtyard.courtthane', bool $finish = true)
    {
        $this->f = $combined;
        ...
        if (!isset($state['model_preparation'])) { (new \App\Imperium\Runtime\Citadel\Formation\FreshInstitutionalPreparation($f->root, $f->store))->initializeModel($initial, $f->sign('INITIALIZE_FORMATION_MODEL_PREPARATION', $initial)); }
    ...
    public function close(): void
    {
        ...
        // The combined fixture owns the shared root lifetime.
    }
}
