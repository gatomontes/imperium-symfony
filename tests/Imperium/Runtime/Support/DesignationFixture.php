...
{
    public ModelPreparationFixture $m;
    public D $service;
    public array $delegations=[];
    private string $secret;
    public function __construct(public string $seat)
    {
        $m=$this->m=new ModelPreparationFixture($seat); $f=$m->f;
        ...
        (new FormationProfileDesignationInitialization($f->journal,$f->signatures))->initialize($head,$f->sign('INITIALIZE_FORMATION_PROFILE_DESIGNATIONS',$terms));
