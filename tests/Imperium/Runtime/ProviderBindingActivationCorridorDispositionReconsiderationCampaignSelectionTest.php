...
final class ProviderBindingActivationCorridorDispositionReconsiderationCampaignSelectionTest extends TestCase
{
    ...
    {
        $root=dirname(__DIR__,3);$ready=preg_replace('/\s+/', ' ', (string)file_get_contents($root.'/docs/handoffs/provider-binding-activation-corridor-disposition-reconsideration-campaign-ready.md'));$next=preg_replace('/\s+/', ' ', (string)file_get_contents($root.'/docs/next-campaign-provider-binding-activation-corridor-disposition-reconsideration.md'));
