...
final class CanonicalNativeEffectReconciliationIssuanceAuthorityRevocationRemediationCampaignReadyTest extends TestCase
{
    ...
    private const string HISTORICAL_PREPARATION_ENTRYPOINT = 'docs/handoffs/canonical-native-effect-reconciliation-issuance-authority-revocation-remediation-preparation-batch-0-local-ready.md';
    ...
    private const string HISTORICAL_BATCH_1_ENTRYPOINT = 'docs/handoffs/canonical-native-effect-reconciliation-issuance-authority-revocation-remediation-batch-1-local-ready.md';
    ...
    {
        foreach ([
            self::HISTORICAL_CAMPAIGN,
            self::HISTORICAL_PREPARATION_ENTRYPOINT,
            self::HISTORICAL_HANDOFF,
            self::HISTORICAL_BATCH_1_ENTRYPOINT,
            self::HISTORICAL_ENTRYPOINT,
        ] as $path) {
