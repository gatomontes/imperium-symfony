...
final class DelegateMissionGuildhallResolutionFlowTest extends TestCase
{
    ...
    {
        return$this->record(['schema'=>'imperium.oracle-model-intelligence-snapshot/v1','snapshot_id'=>'oracle-model-intelligence-'.str_repeat('d',20),'snapshot_generation'=>1,'prior_snapshot'=>null,'instance_id'=>'imperium-test','steward'=>'oracle','actor'=>['office'=>'oracle','seat'=>'oracle.augur'],'models'=>['openai/gpt-delegate@2026-08-01'=>['provider'=>'openai','knowledge'=>['sources'=>['delegate-source'=>['source_id'=>'delegate-source']],'claims'=>['delegate-claim'=>['claim_id'=>'delegate-claim']]],'accessibility'=>['status'=>'ACCESSIBLE'],'admissibility'=>['status'=>'ADMISSIBLE']]],'classification_dimensions'=>['knowledge','accessibility','admissibility'],'status'=>'ORACLE_CANONICAL_CATALOGUE_SNAPSHOT_SEALED_NO_SELECTION_AUTHORITY','model_research_authority'=>false,'selection_authority'=>false]);
    }
